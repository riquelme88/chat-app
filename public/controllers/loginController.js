...
exports.register = exports.login = exports.registerPage = exports.loginPage = exports.redirect = void 0;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user = yield userModel_1.User.findOne({
        where: {
            email,
            password
        }
    });
    user ? res.redirect('/chat') :
        res.render('pages/login', {
